    ...
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="/" class="brand-link">
                ...
                <span class="brand-text font-weight-light">shiap Project</span>
            </a>
            ...
            <div class="sidebar">
                ...
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    {{-- <div class="image">
                        <img src="{{ asset('IVAN.jpg') }}" class="img-circle elevation-2" alt="User Image">
                    </div> --}}
                    <div class="info">
        ...
        <footer class="main-footer">
            <strong>Copyright &copy; 2014-2022 <a href="https://adminlte.io">Project UTS & UAS</a>.</strong>
            All rights reserved.
